<?php
// tappersia/admin/views/banner-types/content-html-sidebar-editor.php
...
<main class="grid grid-cols-12 gap-6 p-6 ltr">
    ...
    <div class="col-span-10 sticky top-[120px] space-y-4">
        <div class="bg-[#434343] p-4 rounded-lg">
            <h3 class="preview-title">HTML Box for Sidebar</h3>
            <textarea 
                v-model="banner.content_html_sidebar.html"
                rows="10"
                ...
                placeholder="Enter your HTML, CSS, and JavaScript code for the sidebar here..."
            ></textarea>
        </div>
        ...
        <div class="bg-[#434343] p-4 rounded-lg">
            ...
            <div 
                ...
                v-html="banner.content_html_sidebar.html"
            >
            </div>
        </div>

...
<div v-if="apiItem" style="display: flex;flex-direction: column;justify-content: space-between;height: 100%;">
    <div>
        ...
        <div class="flex items-center" :style="{ marginTop: currentView === 'mobile' ? '4px' : '9px', justifyContent: settings.layout === 'right' ? 'flex-end' : 'flex-start' }">
    ...
    <div class="flex items-center justify-between" style="margin-top: 11px;">
        <div v-if="currentView === 'desktop'" class="flex items-center" :style="{flexDirection: settings.layout === 'right' ? 'row-reverse' : 'row'}">

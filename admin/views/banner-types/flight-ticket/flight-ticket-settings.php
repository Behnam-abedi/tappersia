...
<div class="gap-6 flex flex-col"  :key="currentView">
    ...
    <div class="bg-[#434343] p-5 rounded-lg shadow-xl mr-2 ">
        <h3 class="font-bold text-xl text-white tracking-wide mb-5 capitalize">{{ currentView }} General Settings</h3>
        <div class="flex flex-col gap-3"> <?php // Using gap-3 like Code 2 ?>
            <div>
    ...
    <?php // *** END: Card 1 - General Settings (Container) *** ?>


    <?php // *** START: Card 2 - Background & Image (MERGED) *** ?>
    <div class="bg-[#434343] p-5 rounded-lg shadow-xl mr-2">
        <h3 class="font-bold text-xl text-white tracking-wide mb-5 capitalize">{{ currentView }} Background & Image</h3>
        <div class="flex flex-col gap-3"> <?php // Using gap-3 like Code 2 ?>
    
            <?php // Section 1: Background Overlay ?>
            <div>
                <h4 class="section-title">Background Overlay</h4>
                
                <div class="flex gap-2 mb-2 bg-[#292929] rounded-lg border-none p-1" >
...
<button v-if="currentView === 'desktop'" @click="addGradientStop(settings.gradientStops)" class="w-full bg-blue-600 text-white text-sm py-2 rounded-md hover:bg-blue-700 mt-2">Add Color Stop</button>                    </div>
                </div>
            </div>

            <hr class="section-divider" v-if="currentView === 'desktop'">

            <?php // Section 2: Banner Image (Moved here) ?>
            <div v-if="currentView === 'desktop'">
                <h4 class="section-title">Image (like Single Banner)</h4>
                <div class="space-y-4 mt-3"> <?php // Re-wrapped in space-y-4 for internal group spacing ?>
                    ...
                    <div v-if="settings.imageUrl" class="mt-3 space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-2 mt-2">
                            <div>
                                ...
                                <input type="number" v-model.number="settings.imagePosLeft" class="yab-form-input">
                            </div>
            ...
            <?php // Section 3: Layers Control (Moved here) ?>
            <div v-if="currentView === 'desktop'">
    ...
    <?php // *** END: Card 2 - Background & Image (MERGED) *** ?>
    

    <?php // *** START: Card 3 - Content (Text) *** ?>
    <div class="bg-[#434343] p-5 rounded-lg shadow-xl mr-2">
        <h3 class="font-bold text-xl text-white tracking-wide mb-5 capitalize">{{ currentView }} Content (Text)</h3>
        <div class="flex flex-col gap-3"> <?php // Using gap-3 like Code 2 ?>

            <?php // Section 1: Content Width ?>
            <div>
                <h4 class="section-title">Layout</h4>
            ...
            <?php // Section 2: Content 1 ?>
            <div :set="content = settings.content1">
                <h4 class="section-title">Content 1</h4>
                <div v-if="currentView === 'desktop'">
                    <label class="setting-label-sm">Text</label>
                    <input type="text" v-model="settings.content1.text" class="yab-form-input">
                </div>
            ...
            <?php // Section 3: Content 2 ?>
            <div :set="content = settings.content2">
                <h4 class="section-title">Content 2</h4>
            ...
            <?php // Section 4: Content 3 ?>
            <div :set="content = settings.content3">
                <h4 class="section-title">Content 3</h4>
    ...
    <?php // *** END: Card 3 - Content (Text) *** ?>


    <?php // *** START: Card 4 - Flight Ticket Box *** ?>
    <div class="bg-[#434343] p-5 rounded-lg shadow-xl mr-2">
        <h3 class="font-bold text-xl text-white tracking-wide mb-5 capitalize">{{ currentView }} Flight Ticket Box</h3>
        <div class="flex flex-col gap-3"> <?php // Using gap-3 like Code 2 ?>
                ...
                <div class="grid grid-cols-3 gap-2 mt-2">
                    <div v-if="currentView === 'desktop'">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <input type="text" v-model="settings.price.color" data-coloris class="yab-form-input clr-field flex-grow">
                        </div>
                    </div>
                    ...
                    <div :class="currentView === 'mobile' ? 'col-span-3' : 'col-span-3'">
            ...
            <div :set="content = settings.button">
                ...
                <div class="grid grid-cols-2 gap-2 mt-2">
                    ...
                    <div :class="currentView === 'mobile' ? 'col-span-3' : ''"><label class="setting-label-sm">Padding Y (px)</label><input type="number" v-model.number="settings.button.paddingY" class="yab-form-input"></div>
                    <div class="col-span-2"><label class="setting-label-sm">Padding X (px)</label><input type="number" v-model.number="settings.button.paddingX" class="yab-form-input"></div>
            ...
            <?php // Section 4: Destination City ?>
    ...
    <?php // *** END: Card 4 - Flight Ticket Box *** ?>

</div>
<?php // --- END: DESIGN SETTINGS WRAPPER --- ?>
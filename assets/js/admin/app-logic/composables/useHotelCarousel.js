...
export const HotelCarouselLogic = {
    ...
    setup(props) {
        ...
        const gridHeight = computed(() => {
            const cardHeight = cardSettings.value.minHeight || 369; // Use height from settings
        ...
        const generateHotelCardHTML = (hotel) => {
            ...
            if (!hotel) {
                return `
                <div name="card-skeleton" class="yab-hotel-card-skeleton yab-skeleton-loader" style="margin: 0; height:auto;min-height:${card.height || 369}px; width: ${props.settings.cardWidth || 295}px; border-radius: 16px; border: 1px solid #f5f5f5ff; padding: 9px; background-color: #ffffff; box-sizing: border-box; overflow: hidden;">
            ...
            return `
            <div name="card" class="yab-hotel-card" style="margin: 0; height:auto;min-height: ${card.minHeight || 369}px; width: ${props.settings.cardWidth || 295}px; border-radius: ${card.borderRadius}px; border: ${card.borderWidth}px solid ${card.borderColor}; padding: ${card.padding}px; background-color: ${card.bgColor}; box-sizing: border-box; font-family: 'Roboto', sans-serif; display: flex; flex-direction: column;">

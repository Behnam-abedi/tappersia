...
const YabModal = {
  ...
  template: `
    <div v-if="isVisible" class="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-center justify-center p-4" @click.self="handleConfirm(false)">
        <div class="bg-[#434343] rounded-lg shadow-xl p-6 w-full max-w-md text-center transform transition-all" :class="isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'">
